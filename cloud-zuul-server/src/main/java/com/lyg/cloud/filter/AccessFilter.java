 ...
 * 
 * @author youguang.li
 *	我们对外开放服务还需要一些安全措施来保护客户端只能访问它应该访问到的资源。所以我们需要利用Zuul的过滤器来实现我们对外服务的安全控制。
...
public class AccessFilter extends ZuulFilter  {
    ...
    /**
     * 返回一个boolean类型来判断该过滤器是否要执行，所以通过此函数可实现过滤器的开关。在本例中，我们直接返回true，所以该过滤器总是生效。
     */
    @Override
